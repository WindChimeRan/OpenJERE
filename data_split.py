...
def _split_cond(cond: str, data_root: str):
    ...
    if cond == 'chinese_test':
        ...
        print('chinese validate sent %d, triplet %d' %
              (validate_sent, validate_triplet))
        ...
        with open(source, 'r') as s, open(target, 'w') as t:
            for line in s:
                ...
                all_triplet_num += triplet_num
                all_sent_num += 1
        print('webnlg train sent %d, triplet %d' %
              (all_sent_num, all_triplet_num))
        ...
        with open(source, 'r') as s, open(target, 'w') as t:
            for line in s:
                ...
                all_triplet_num += triplet_num
                all_sent_num += 1
        print('webnlg dev sent %d, triplet %d' %
              (all_sent_num, all_triplet_num))
        ...
        with open(source, 'r') as s, open(target, 'w') as t:
            for line in s:
                ...
                all_triplet_num += triplet_num
                all_sent_num += 1
        print('webnlg test sent %d, triplet %d' %
              (all_sent_num, all_triplet_num))
        ...
        with open(source, 'r') as s, open(target, 'w') as t:
            for line in s:
                ...
                if cond == 'test5' and triplet_num >= 5:
                    ...
                    pass
        print(data_root + ' ' + cond + ' sent %d, triplet %d' %
              (all_sent_num, all_triplet_num))
